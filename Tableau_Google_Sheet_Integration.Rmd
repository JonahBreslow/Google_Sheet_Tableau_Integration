...
## Purpose
The purpose of this document is to describe a pipeline to automatically refresh a Tableau Public document more than once every 24 hours, at whatever schedule is required, using python. This is important because currently Tableau Public updates Google Sheet connections only oncer per day.
